...
[A skill is a set of instructions - packaged as a simple folder - that teaches Claude](https://claude.com/blog/skills)
...
💡 _Building standalone skills without MCP? Skip to Planning and Design - you can_

_always return here later._


[If you already have a working MCP server, you've done the hard part. Skills are](https://support.claude.com/en/articles/10949351-getting-started-with-local-mcp-servers-on-claude-desktop)
...
_Real example:_ [frontend-design skill (also see skills for docx, pptx, xlsx, and](https://github.com/anthropics/skills/tree/main/skills/frontend-design)

[ppt)](https://github.com/anthropics/skills/tree/main/skills)
...
_–_ _How to measure:_ Run 10-20 test queries that should trigger your skill. Track
...
_–_ _How to measure:_ Compare the same task with and without the skill enabled.
...
_–_ _How to measure:_ Monitor MCP server logs during test runs. Track retry rates
...
_–_ _How to assess:_ During testing, note how often you need to redirect or clarify.
...
_–_ _How to assess:_ Run the same request 3-5 times. Compare outputs for
...
_–_ _How to assess:_ Can a new user accomplish the task on first try with minimal
...
[According to Anthropic's engineering blog: "This metadata...provides just](https://www.anthropic.com/engineering/equipping-agents-for-the-real-world-with-agent-skills)
...
_Adapt this template for your skill. Replace bracketed sections with your specific_
...
``references/`` [and link to it. (See Core Design Principles for how the three-](https://www.anthropic.com/engineering/equipping-agents-for-the-real-world-with-agent-skills)
...
Use the metrics from Defne Success Criteria. Here's what a comparison might
...
_Note: skill-creator helps you design and refine skills but does not execute_

_automated test suites or produce quantitative evaluation results._
...
[We've published Agent Skills as an open standard. Like MCP, we believe skills](https://agentskills.io/home)
...
[instructions. Code is deterministic; language interpretation isn't. See the Ofce](https://github.com/anthropics/skills/tree/main/skills)

[skills for examples of this pattern.](https://github.com/anthropics/skills/tree/main/skills)
...
[• Document Skills - PDF, DOCX, PPTX, XLSX creation](http://https://github.com/anthropics/skills/tree/main/skills/pdf)


- [Example Skills - Various workflow patterns](https://github.com/anthropics/skills/tree/main/skills)


- [Partner Skills Directory - View skills from various partners such as Asana,](https://www.claude.com/connectors)
